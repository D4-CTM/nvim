...
local util = require('utils.lspTools')

local function lspStart()
	local lspsPath = vim.fn.stdpath("data") .. "/mason/bin/"
	local clangdPath = lspsPath .. "clangd"
	local ardLsp = lspsPath .. "arduino-language-server"
	-- hardcoded, for now
